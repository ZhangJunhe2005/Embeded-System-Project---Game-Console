...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(PS2_CLK_Pin);
...
void TIM6_DAC_IRQHandler(void)
{
  ...
  if (Game3Audio_IsPlaying()) {
    Game3Audio_TIM6_IRQHandler();
  } else if (Game2Music_IsPlaying()) {
    Game2Music_TIM6_IRQHandler();
  } else {
    Audio_TIM6_IRQHandler();
  }
  TIM6->SR &= ~TIM_SR_UIF;
  return;
