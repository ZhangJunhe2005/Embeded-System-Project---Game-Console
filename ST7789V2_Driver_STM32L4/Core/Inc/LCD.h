...
#define LCD_REFRESH_LINES_PER_CHUNK 8u
#define LCD_WORK_BUFFER_BYTES (BUFFER_LENGTH + 8u)
...
/* Attach caller-owned work RAM used by the LCD framebuffer and refresh buffers. */
